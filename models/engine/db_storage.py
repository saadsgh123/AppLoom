...
class DBStorage:
    ...
    def insert_many(self, data_list):
        ...
        """
        return self.collections["__class__"].insert_many(data_list)
    ...
    def find_one(self, query):
        ...
        """
        return self.collections["__class__"].find_one(query)
    ...
    def find_all(self):
        ...
        """
        return list(self.collections["__class__"].find())
    ...
    def update_one(self, query, update):
        ...
        """
        return self.collections["__class__"].update_one(query, update)
    ...
    def delete_one(self, query):
        ...
        """
        return self.collections["__class__"].delete_one(query)
    ...
    def delete_many(self, query):
        ...
        Returns:
            DeleteResult: The result of the delete operation.
        """
        return self.collections["__class__"].delete_many(query)
